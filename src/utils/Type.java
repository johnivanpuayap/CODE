...
public enum Type {
    ...
    FOR, BEGIN_FOR, END_FOR, BREAK, CONTINUE
}
    DISPLAY, DELIMITER, CONCATENATION, STRING_LITERAL, COLON, NEXT_LINE, SPECIAL_CHARACTER, ESCAPE_CODE_OPEN,
    ESCAPE_CODE_CLOSE, EXPRESSION,
    WHILE, BEGIN_WHILE, END_WHILE,
