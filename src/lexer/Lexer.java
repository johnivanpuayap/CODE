    ...
    public List<Token> tokenize() {
        ...
        while (counter < input.length()) {
            ...
            if(input.startsWith("BEGIN CODE", counter)) {
                tokens.add(new Token(Type.BEGIN_CODE, "BEGIN CODE", new Position(position.getLine(), position.getColumn())));
                position.add("BEGIN CODE".length());
                counter += "BEGIN CODE".length();
            } else if(input.startsWith("END CODE", counter)) {
                tokens.add(new Token(Type.END_CODE, "END CODE", new Position(position.getLine(), position.getColumn())));
                ...
                tokens.add(new Token(Type.BEGIN_IF, "BEGIN IF", new Position(position.getLine(), position.getColumn())));
                ...
                tokens.add(new Token(Type.BEGIN_WHILE, "BEGIN WHILE", new Position(position.getLine(), position.getColumn())));
                ...
                tokens.add(new Token(Type.LEFT_PARENTHESIS, "(", new Position(position.getLine(), position.getColumn())));
                position.add(1);
                counter++;
            } else if(currentChar == ')') {
                tokens.add(new Token(Type.RIGHT_PARENTHESIS, ")", new Position(position.getLine(), position.getColumn())));
                position.add(1);
                counter++;
            } else if( currentChar == '[') {
                tokens.add(new Token(Type.ESCAPE_CODE_OPEN, ")", new Position(position.getLine(), position.getColumn())));
                position.add(1);
                counter++;
            } else if( currentChar == '[') {
                ...
                if(input.charAt(counter + 1) == '=') {
                    tokens.add(new Token(Type.GREATER_EQUAL, ">=", new Position(position.getLine(), position.getColumn())));
                    position.add(2);
                    counter += 2;
                } else {
                ...
                if(input.charAt(counter + 1) == '=') {
                    tokens.add(new Token(Type.LESS_EQUAL, "<=", new Position(position.getLine(), position.getColumn())));
                    position.add(2);
                    counter += 2;
        ...
        while (counter < input.length() && input.charAt(counter) != '\n') {
            ...
            // Tokenize newline character
                ...
                if(input.charAt(counter) == '[' && input.charAt(counter + 1) == ']') {
                    tokens.add(new Token(Type.SPECIAL_CHARACTER, Character.toString(input.charAt(counter)), new Position(position.getLine(), position.getColumn())));
                    position.add(1);
                    counter++;
            ...
            // Tokenize quotation marks and string literal
                ...
                tokens.add(new Token(Type.DELIMITER, Character.toString('"'), new Position(position.getLine(), position.getColumn())));
                position.add(1);
                counter++;
                ...
                while (counter < input.length() && input.charAt(counter) != '\n' && input.charAt(counter) != '&') {
                    if (input.charAt(counter) == '"') {
                        tokens.add(new Token(Type.STRING_LITERAL, stringLiteral.toString(), new Position(position.getLine(), position.getColumn())));
                        tokens.add(new Token(Type.DELIMITER, Character.toString('"'), new Position(position.getLine(), position.getColumn())));
                        position.add(1);
                        counter++;
                        break;
                ...
                tokens.add(new Token(Type.IDENTIFIER, variableName.toString(), new Position(position.getLine(), position.getColumn())));
            }
        }
